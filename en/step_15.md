...
- Click **File** -- **Save As**, give your program a name e.g. [`env.py`](resources/env.py), then press **F5** to run.
...
- Click **File** -- **Save As**, give your program a name e.g. [`scrolling_env.py`](resources/scrolling_env.py), then press **F5** to run.
