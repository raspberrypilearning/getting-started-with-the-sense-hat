...
- Click **File** -- **Save As**, give your program a name e.g. [`rainbow_flip.py`](resources/rainbow_flip.py), then press **F5** to run.
...
- Click **File** -- **Save As**, give your program a name e.g. [`spinning_j.py`](resources/spinning_j.py), then press **F5** to run.
...
- Click **File** -- **Save As**, give your program a name e.g. [`eyes.py`](resources/eyes.py), then press **F5** to run.
