...
- The LED matrix can also display a single character, rather than an entire message, using the `sense.show_letter` function which also has some optional **parameters**.
    ...
    Click **File** -- **Save As**, give your program a name eg [`omg.py`](resources/omg.py), then press **F5** to run.
...
- Click **File** -- **Save As**, give your program a name eg [`random_omg.py`](resources/random_omg.py), then press **F5** to run.
